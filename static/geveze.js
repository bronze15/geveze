...
(function () {
    ...
    var example_data = {
        plain_message: {action: "message", type: "plain", body: "Selam"},
        photo_message: {
            action: "message", type: "image", description: "photo description",
            images: [
        ...
        audio_message: {action: "message", type: "audio", audios: []},
        video_message: {
            action: "message", type: "video", videos: [
        ...
        avatar_upload: {action: "avatar", type: "upload", data: "my-cool-avatar.jpg"},
        avatar_change: {action: "avatar", type: "change", data: "my-new-cool-avatar.jpg"},
        pulse: {action: "pulse", type: "notification", people: []},
    };
